...
msvc12)
  ...
  l_dlib="./build/$tbs_conf/raw.lib"
  l_bin="./build/$tbs_conf/raw.dll"
...
gnu)
  ...
  c_flags+=" -fPIC"
  make="make $target"
  l_slib="./build/libraw_static.a"
  l_dlib="./build/libraw.so"
  l_bin="$l_dlib"
...
mingw)
  ...
  l_slib="./build/libraw_static.a"
  l_dlib="./build/libraw.dll.a"
  l_bin="./build/libraw.dll"
  list="$l_bin $l_slib $l_dlib $l_inc" ;;
